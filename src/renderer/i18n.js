...
const zh = {
  ...
  "dashboard.doing": "在做",
  "dashboard.lastQuery": "最近用户 query",
  "dashboard.nowDoing": "当前概述",
  "dashboard.noQuery": "暂无用户输入",
...
const en = {
  ...
  "dashboard.lastQuery": "Last user query",
  "dashboard.nowDoing": "Current summary",
  "dashboard.noQuery": "No user input yet",
